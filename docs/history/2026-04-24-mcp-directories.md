...
- Description to use: "Remote MCP server at domainposture.com — 10 domain-dossier checks (dns, mx, spf, dmarc, dkim, tls, redirects, headers, cors, web-surface), 10 developer utilities (base64, jwt, dns-lookup, uuid, url codec, json, ua, ip-lookup), and an aggregate dossier_full tool. Streamable HTTP."
